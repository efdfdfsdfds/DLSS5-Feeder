...
rem reshade.hpp: in MGPU Bridge mode this exe registers itself with its own ReShade as an add-on.
cl /nologo /O2 /EHsc /W3 /MD /std:c++17 /DFEED_BUILD_ID=\"%FEED_BUILD_ID%\" /I..\external\ngx /I..\external\reshade\include dlss5-feed-host64.cpp ^
